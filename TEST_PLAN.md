...
| `test/providers/sync_offline_pull_test.dart` | Real notifier, service, queue and Drift with a cache/server Firestore boundary: unavailable collections or an unconfirmed server boundary prevent success and watermark advancement; slow pulls, clock skew, timestamp precision, client-timed pieces, legacy-marker recovery and failed-migration retries | 27 |
