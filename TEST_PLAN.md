...
| `test/database/local_database_bootstrap_test.dart` | Launch decision table (first launch / reinstall / update / restore / key mismatch) and the three recovery paths, against a real Drift file with a SQLCipher stand-in (`test/helpers/fake_sqlcipher.dart`) | 22 |
