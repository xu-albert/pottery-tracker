-- Schema version 8 (4bd9e29) — version 7 plus deleted_junctions, the tombstone
-- table sync uses. The last version before the current one.
CREATE TABLE "pieces" (
  "id" TEXT NOT NULL,
  "title" TEXT NULL,
  "stage" TEXT NULL,
...
CREATE TABLE "deleted_junctions" (
  "id" TEXT NOT NULL,
